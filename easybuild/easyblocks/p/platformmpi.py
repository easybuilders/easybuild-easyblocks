...
##
"""
Easyblock for installing PlatformMPI. Based on easyblock for tarball installation.
@author: Ahmed Sajid (STFC)

Original detail as follows:
...
class EB_PlatformMPI(EasyBlock):
    """
    ...
    def make_module_req_guess(self):
        """Specify MPI custom values for PATH etc."""

        guesses = super(EB_PlatformMPI, self).make_module_req_guess()
    ...
    def make_module_extra(self):
        ...
        txt = super(EB_PlatformMPI, self).make_module_extra()
        txt += "setenv\t%s\t\t$root\n" % ('MPI_ROOT')
