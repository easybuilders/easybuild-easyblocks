...
from easybuild.tools.filetools import apply_regex_substitutions, adjust_permissions, change_dir, copy_file, search_file, copy_dir
                ...
                if os.path.exists(wrappers_dir):
                    ...
                    if py_exe is not None:
                        if not isinstance(py_exe, str) or not py_exe:
                            ...
                            # as this is the executable that runs EasyBuild and may be unavailable when using th    e buildenv wrappers.
