...
class ConfigureMake(EasyBlock):
    ...
    def configure_step(self, cmd_prefix=''):
        ...
        # Avoid using config.guess from an Autoconf generated package as it is frequently out of date, use the version
        # shipped with EB instead and provide the result to the configure command
        build_type_option = ''
        if 'Generated by GNU Autoconf' in open(cmd_prefix + 'configure').read():
