...
from easybuild.tools.filetools import CHECKSUM_TYPE_SHA256, adjust_permissions, compute_checksum
...
# download locations & SHA256 for config.guess script
CONFIG_GUESS_VERSION = '2025-07-10'
...
def obtain_config_guess(easyblock=None, download_source_path=None, search_source_paths=None):
    """
...
class ConfigureMake(EasyBlock):
    ...
    def obtain_config_guess(self, download_source_path=None, search_source_paths=None):
        ...
        return obtain_config_guess(
            ...
            search_source_paths=search_source_paths,
        )
