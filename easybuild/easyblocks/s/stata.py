...
class EB_Stata(PackedBinary):
    ...
    def sanity_check_step(self):
        ...
        res = run_shell_cmd(f"file {stata_bin}")
        ...
        if 'ELF' in res.output:
            ...
            res = run_shell_cmd(f"ldd {stata_bin}")
            ...
            self.log.info(f"sanity_check_step: {stata_bin} is not an ELF binary, skipping ldd check")
